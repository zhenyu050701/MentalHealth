...
def ask_questions():
    ...
    for question in questions:
        if question["key"] == "self_harm" or question["key"] == "traumatic_event":
            # Ensures self-harm and traumatic event are binary selections (1 = Yes, 0 = No)
            ...
            # Default slider for other questions
